...
<head>
    ...
    <link rel="stylesheet" href="/hackathon/css/patient/chat.css">
    <style>
        :root {
            /*!* Primary colors *!*/
            /*--color-primary-dark: #2E2E2E;*/
            /*--color-primary-accent: #00B2A9;*/

            /*!* Secondary colors - za obavjestenja *!*/
            /*--color-secondary-yellow: #FFC20E;*/
            /*--color-secondary-purple: #8E7CC3;*/
        ...
        /* Prescription colors (using secondary purple) */
        ...
        /* Medical orders colors (using secondary yellow) */
        ...
        .appointment-item, .prescription-item, .reminder-item {
            padding: 15px;
            border-bottom: 1px solid var(--color-neutral-grey);
        }

        .appointment-item:last-child, .prescription-item:last-child, .reminder-item:last-child {
            border-bottom: none;
        }
...
<!-- Chat toggle button -->
<div id="chat-toggle" onclick="toggleChat()" title="Open chat">
    💬
</div>
...
<div id="chat-container">
    <div id="chat-header">
        AI Chat Assistant
        <span onclick="toggleChat()" id="chat-close">_</span>
    </div>
...
<script>
    ...
    document.getElementById('send-btn').addEventListener('click', function () {
        ...
        msgBox.innerHTML += `<div class="chat-message user">${userInput}</div>`;
        ...
        fetch('chat_response.php', {
            ...
            .then(reply => {
                msgBox.innerHTML += `<div class="chat-message bot">${reply}</div>`;
